                ...
                <div className='border bg-[#1b30445b] text-white rounded'>
                    ...
                    <div className="p-5">
                        <form onSubmit={handleRegister} className="flex flex-col w-full px-4 mx-auto">
                            ...
                            <input className="bg-[#1B3044] rounded text-xl py-2 pl-4 text-white focus:outline-none focus:ring-0 placeholder:text-white" type="text" name="name" placeholder="Enter your full name" required />
                            ...
                            <input className="bg-[#1B3044] rounded text-xl py-2 pl-4 text-white placeholder:text-white focus:outline-none  focus:ring-0" type="text" placeholder="Enter your photo url" name="photo" required />
                            ...
                            <input className="bg-[#7D2AE8] rounded py-2 my-5 text-white font-medium text-xl hover:cursor-pointer" type="submit" value="Register" />
